...
class TOtpUserUseCaseTest {
  ...
  void getUserStatus_NoUser_Test() {
    ...
    TOtpUserStatusDto expected =
        TOtpUserStatusDto.builder()
            .statusCode("N")
            .statusDescription("No Active Subscription")
            .build();
    doReturn(Mono.empty()).when(this.tOtpUserMasterSPI).findById(any());
    doReturn(Mono.just(expected)).when(this.tOtpGetUserStatusHelper).recordNotFound();
  ...
  void getUserStatus_CheckStatus_Test() {
    ...
    TOtpUserMasterDto tOtpUserMasterDto = TOtpUserMasterDto.builder().status("A").build();
    ...
    doReturn(Mono.just(tOtpUserMasterDto)).when(this.tOtpUserMasterSPI).findById(any());
    doReturn(Mono.just(expected)).when(this.tOtpGetUserStatusHelper).userStatusFromDatabase(any());
  ...
  void unBlockUser_NoUser_Test() {
    ...
    doReturn(Mono.empty()).when(this.tOtpUserMasterSPI).findById(any());
    doReturn(Mono.just(expected)).when(this.tOtpUnBlockUserHelper).formatNoSubscriptionMessage();
  ...
  void unBlockUser_UserExists_Test() {
    ...
    TOtpUnBlockUserDto expectedFail =
        TOtpUnBlockUserDto.builder()
            .statusCode("200")
            .statusDescription("No active subscription found for user")
            .build();
    ...
    doReturn(Mono.just(tOtpUserMasterDto)).when(this.tOtpUserMasterSPI).findById(any());
    doReturn(true)
        .when(this.tOtpUnBlockUserHelper)
        .isUserDisabledOrActive(any(TOtpUserMasterDto.class));

    doReturn(Mono.just(expectedFail))
        .when(this.tOtpUnBlockUserHelper)
    ...
    doReturn(Mono.error(new NonFatalException("300", "Failure in updating")))
        .when(this.tOtpUnBlockUserHelper)
        .changeFlagInDatabase(any(), any(TOtpUserMasterDto.class));

    TOtpUnBlockUserDto expectedException =
        TOtpUnBlockUserDto.builder()
            .statusCode("300")
            .statusDescription("Failure in updating")
            .build();

    doReturn(Mono.just(expectedException)).when(this.tOtpUnBlockUserHelper).fallbackMethod(any());
  ...
  void unSubscribe_NoUser_Test() {
    TOtpUnSubscribeUserDto expected =
    ...
    doReturn(Mono.empty()).when(this.tOtpUserMasterSPI).findById(any());
    doReturn(Mono.just(expected)).when(this.tOtpUnSubscribeUserHelper).formatNoRecordFoundMessage();
  ...
  void unSubscribe_Flow_Test() {
    ...
    TOtpUserMasterDto tOtpUserMasterDto = TOtpUserMasterDto.builder().status("N").build();
    ...
    TOtpUnSubscribeUserDto exception1 =
        TOtpUnSubscribeUserDto.builder()
            .statusCode("200")
            .statusDescription("You have already Unsubscribed from TOTP")
            .build();

    TOtpUnSubscribeUserDto exception2 =
        TOtpUnSubscribeUserDto.builder()
            .statusCode("300")
    ...
    doReturn(Mono.just(tOtpUserMasterDto)).when(this.tOtpUserMasterSPI).findById(any());
    doReturn(Mono.just(expected)).when(this.tOtpUnSubscribeUserHelper).formatNoRecordFoundMessage();
    doReturn(Mono.error(new NonFatalException("200", "You have already Unsubscribed from TOTP")))
        .when(this.tOtpUnSubscribeUserHelper)
        .isUserDisabledOrNonActive(any(TOtpUserMasterDto.class));
    doReturn(Mono.just(exception1)).when(this.tOtpUnSubscribeUserHelper).fallbackMethod(any());
    ...
    doReturn(Mono.just(tOtpUserMasterDto)).when(this.tOtpUserMasterSPI).findById(any());
    doReturn(Mono.just(exception2)).when(this.tOtpUnSubscribeUserHelper).fallbackMethod(any());
    doReturn(
        Mono.error(
    ...
    TOtpUnSubscribeUserDto success =
        TOtpUnSubscribeUserDto.builder()
            .statusCode("200")
            .statusDescription("TOTP subscription cancelled for user")
            .build();
    ...
    doReturn(Mono.just(tOtpUserMasterDto)).when(this.tOtpUserMasterSPI).findById(any());
    doReturn(Mono.just(tOtpUserMasterDto))
        .when(this.tOtpUnSubscribeUserHelper)
        .isUserDisabledOrNonActive(any(TOtpUserMasterDto.class));
    doReturn(Mono.just(success)).when(this.tOtpUnSubscribeUserHelper).updateDbToUnsubscribe(any());
    StepVerifier.create(tOtpUserUseCase.unSubscribe("TEST_SYSTEM", "TEST_USER"))
        .assertNext(
            actual -> {
  ...
  void verify_NoUser_Test() {
    ...
    doReturn(Mono.empty()).when(this.tOtpUserMasterSPI).findById(any());
    doReturn(Mono.just(expected)).when(this.tOtpVerifyHelper).formatNoSubscriptionMessage();
  ...
  void verify_Flow_Test() {
    ...
    doReturn(Mono.just(expected)).when(this.tOtpVerifyHelper).formatNoSubscriptionMessage();
    doReturn(
        Mono.error(new NonFatalException("300", "Access is inactive or disabled for the user")))
        .when(this.tOtpVerifyHelper)
        .isUserNotActive(any(TOtpUserMasterDto.class));
    doReturn(Mono.just(exception1)).when(this.tOtpVerifyHelper).fallbackMethod(any());
  ...
  void createTOtpSecret_NoUser_Test() {
    ...
    doReturn(Mono.empty()).when(this.tOtpUserMasterSPI).findById(any());
    doReturn(Mono.just(expected)).when(this.tOtpCreateSecretHelper).createNewRecord(any(), any());
  ...
  void createTOtpSecret_Flow_Test() {
    ...
    TOtpUserMasterDto tOtpUserMasterDto = TOtpUserMasterDto.builder().status("D").build();
    ...
    TOtpCreateNewDto exception1 =
        TOtpCreateNewDto.builder()
            .statusCode("300")
            .statusDescription("Your TOTP is disabled. Contact administrator")
            .build();

    TOtpCreateNewDto exception2 =
        TOtpCreateNewDto.builder()
            .statusCode("300")
            .statusDescription("Your TOTP is blocked. Please contact administrator to unblock.")
            .build();
    ...
    doReturn(
        ...
        .when(this.tOtpCreateSecretHelper)
        .isAllowedToReset(any(TOtpUserMasterDto.class));
    doReturn(Mono.just(exception1)).when(this.tOtpCreateSecretHelper).fallbackMethod(any());
    ...
    doReturn(Mono.just(tOtpUserMasterDto))
        .when(this.tOtpCreateSecretHelper)
        .isAllowedToReset(any(TOtpUserMasterDto.class));
    doReturn(Mono.just(success)).when(this.tOtpCreateSecretHelper).updateDbToReset(any(), any());
    StepVerifier.create(tOtpUserUseCase.createTOtpSecret("TEST_SYSTEM", "TEST_USER"))
        .assertNext(
            actual -> {
              assertEquals(success.toString(), actual.toString());
  ...
  void generateQr_NoUser_Test() {
    ...
    doReturn(Mono.empty()).when(this.tOtpUserMasterSPI).findById(any());
    doReturn(Mono.just(expected)).when(this.tOtpGenerateQrHelper).formatNoSubscriptionMessage();
  ...
  void generateQr_Flow_Test() {
    ...
    TOtpGenerateQrDto exception1 =
        TOtpGenerateQrDto.builder()
            .statusCode("300")
            .statusDescription("Your TOTP is disabled. Contact administrator")
            .build();

    TOtpGenerateQrDto exception2 =
        TOtpGenerateQrDto.builder()
            .statusCode("300")
            .statusDescription("Your TOTP is blocked. Please contact administrator to unblock.")
            .build();
    ...
    doReturn(
        Mono.error(
            new NonFatalException("300", "Your TOTP is disabled. Contact administrator")))
        .when(this.tOtpGenerateQrHelper)
        .canGenerateQr(any(TOtpUserMasterDto.class));
    doReturn(Mono.just(exception1)).when(this.tOtpGenerateQrHelper).fallbackMethod(any());
    ...
    doReturn(Mono.just(tOtpUserMasterDto))
        .when(this.tOtpGenerateQrHelper)
        .canGenerateQr(any(TOtpUserMasterDto.class));
    doReturn(Mono.just(success)).when(this.tOtpGenerateQrHelper).generateQr(any(), any());
    StepVerifier.create(tOtpUserUseCase.generateQr("TEST_SYSTEM", "TEST_USER"))
        .assertNext(
            actual -> {
              assertEquals(success.toString(), actual.toString());
