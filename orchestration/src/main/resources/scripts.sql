DROP DATABASE IF EXISTS `COAUTH`;

CREATE DATABASE IF NOT EXISTS `COAUTH`;
...
INSERT INTO COAUTH.SYSTEM_MASTER (SYSTEM_ID,SYSTEM_NAME,SYSTEM_DESCRIPTION,STATUS,MODIFICATION_ID,
MODIFICATION_DATE_TIME,CREATION_ID,CREATION_DATE_TIME)
VALUES
('MAIN-','MAIN','ROOT SYSTEM NAME','A','DEFAULT',NOW(),'DEFAULT',NOW());

INSERT INTO COAUTH.SYSTEM_USER_MASTER (ACCESS_ID,SYSTEM_ID,USER_NAME,USER_SECRET,USER_FULL_NAME,
