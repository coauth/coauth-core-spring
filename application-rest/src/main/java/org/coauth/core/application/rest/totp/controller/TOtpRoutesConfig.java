...
public class TOtpRoutesConfig {
  ...
  @RouterOperations({
      @RouterOperation(
          ...
          @Operation(
              ...
              @RequestBody(
                  content =
                  @Content(schema = @Schema(implementation = GenericRequest.class))))),
      @RouterOperation(
          path = "/totp/verify",
          produces = {MediaType.APPLICATION_JSON_VALUE},
          method = RequestMethod.POST,
          ...
          @Operation(
              ...
              @RequestBody(
                  content =
                  @Content(schema = @Schema(implementation = VerifyTOtpRequest.class))))),
      @RouterOperation(
          path = "/totp/subscribe",
          produces = {MediaType.APPLICATION_JSON_VALUE},
          method = RequestMethod.POST,
  ...
  RouterFunction<ServerResponse> getStatus(
      TOtpStatusHandler tOtpStatusHandler,
